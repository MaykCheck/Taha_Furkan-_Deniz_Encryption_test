...
def şifre_çözme():
    ...
    if len(şifrelenmiş_mesaj) == 0 or len(şifre) == 0:
        ...
        try:
            ...
            messagebox.showinfo(title="HATA!", message="Girilen verinin doğrulundan emin olunuz!")
...
metin_girişi_başlığı = Label(text="Lütfen Şifrelenecek Metninizi Giriniz", font=FONT)
